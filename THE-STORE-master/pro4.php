...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="d" style="height:70%;" src="4.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">Libas Women Blue and Green Printed Anarkali Kurta</h3>

        <p style="color:black;"><del>₹1699</del><font color="red"> (50% off)</font><br>₹849 </p>
       ...
       <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="4">
             <?php
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Blue and green printed Anarkali kurta, has a round neck,
          short button placket, three quarter sleeves, flared hem</font></h5>
