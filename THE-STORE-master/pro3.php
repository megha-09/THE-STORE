...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="c" style="height:70%;" src="3.jpg" ></img>
    ...
    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">HERE and NOW Women Orange and Grey Printed Straight Kurta</h2>

        <p style="color:black;"><del>₹899</del><font color="red"> (50% off)</font><br>₹449 </p>
       ...
       <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="3">
             <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Orange and grey printed straight kurta, has a round neck,
          three-quarter sleeves, a straight hem, and side slits</font></h5>


            <h5 style="font-size:100%; color:black;">Material and Care<br><font color="grey">100% crepe<br>Machine-wash cold</font></h5>
        </div>
