...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="q" style="height:70%;" src="17.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">Jaguar Classic Men Eau De Toilette</h3>

        <p style="color:black;"><del>₹3300</del><font color="red"> (50% off)</font><br>₹1650 </p>
        ...
        <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
          <input type="radio" name="size" value="small">100ml</input>
            ...
            <input type="hidden" name="prodno" value="17">
             <?php
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Jaguar Classic Eau De Toilette<br>
              Medium fragrance (lasts 2-3 hours)<br>
The top notes of mandarin, lavender, basil and citrus<br>
The heart notes of orange and lotus flower with a spicy ginger twist <br>
The base notes of sandalwood, benzoe and white musk<br>
</font></h5>
