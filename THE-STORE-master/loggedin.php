	 		...
	 		{ 
	 			...
	 			$query = mysqli_query($con,"SELECT * FROM websiteusers WHERE userName = '$userName' AND pass = '$pass'");
	 		 	...
	 		 	{ 
	 		 		...
	 		 		echo "<br>";
	 		 		echo"<a href='register.html'>REGISTER NOW</a> ";
	 		    } 
...
?>
        <li><form action="home.php" method="POST"><input type='submit' value='LOGOUT' style="background-color:black;color:#66CCCC;border:none;"></form></li>
      </ul>
    </div>
    ...
    <div style="font-family:Lato;">
      ...
      <footer>
        <ul class="nospace inline pushright">
          <li><a class="btn" href="#">SHOP NOW</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear">
    ...
    <article class="one_third first">
      ...
      <footer><a class="btn inverse" href="#">Start Shopping &raquo;</a></footer>
    </article>
