...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="e" style="height:70%;" src="5.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">Azira Women Pink Printed Anarkali Kurta</h3>

        <p style="color:black;"><del>₹1499</del><font color="red"> (60% off)</font><br>₹599 </p>
       ...
       <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="5">
             <?php
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Pink printed Anarkali kurta, has a keyhole neckline,
          three-quarter sleeves, a flared hem, no slits</font></h5>


            <h5 style="font-size:100%; color:black;">Material and Care<br><font color="grey">Polyester<br>Machine-wash cold</font></h5>
        </div>
