...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="l" style="height:70%;" src="12.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">HERE & NOW Men Navy Blue & Grey Colourblocked Round Neck T-shirt</h3>

        <p style="color:black;"><del>₹699</del><font color="red"> (50% off)</font><br>₹449 </p>
        ...
        <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="12">
             <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product: Details<br><font color="grey">Navy blue and grey colour blocked T-shirt, has a round neck,
          long sleeves, 1 pocket</font></h5>


            <h5 style="font-size:100%; color:black;">Material and Care<br><font color="grey">cotton<br>Machine-wash</font></h5>
        </div>
