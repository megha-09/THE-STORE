...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="i" style="height:70%;" src="9.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">HERE&NOW Men Maroon & Grey Melange Colourblocked Round Neck T-shirt</h3>

        <p style="color:black;"><del>₹699</del><font color="red"> (50% off)</font><br>₹399 </p>
        ...
        <h5 style="font-size:100%; color:black;">SELECT SIZE</h5>
         <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="9">
             <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Maroon and grey melange colourblocked T-shirt, has a round neck,
          long sleeve</font></h5>
