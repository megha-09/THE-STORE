...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id = "a" style="height:70%;" src="1.jpg" ></img>
...
<div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">Rain and Rainbow Women Black Printed Straight Kurta</h2>

        <p style="color:black;"><del>₹1195</del><font color="red"> (30% off)</font><br>₹836 </p>
      ...
      <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Black printed straight kurta, has a mandarin collar, three-quarter sleeves,
            curved hem, side slits</font></h5>


            <h5 style="font-size:100%; color:black;" >Material and Care<br><font color="grey">100% cotton<br>Dry-clean</font></h5>
        </div>
