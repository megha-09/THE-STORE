...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="n" style="height:70%;" src="14.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">DAVID BECKHAM Men Classic Eau De Toilette Perfume</h3>

        <p style="color:black;"><del>₹2900</del><font color="red"> (50% off)</font><br>₹1450 </p>
        ...
        <form class="one_half two_quarter" style="color:black;">
            <input type="radio" name="size" value="small">90ml</input>
        ...
        <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
           ...
           <input type="radio" name="size" value="small">90ml</input>
            ...
            <input type="hidden" name="prodno" value="14">
             <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:90%; color:black;">Product Details:<br><font color="grey">DAVID BECKHAM Classic Eau De Toilette perfume<br>
        Medium perfume<br>
        Lasts for two to three hours<br>
        Top notes include fresh citrus flavors of gin and tonic, lime and galbanum<br>
        Cypress, nutmeg and fresh mint in the heart<br>
        Rounded by the warm woody base of vetiver, cedar and amber</font></h5>
