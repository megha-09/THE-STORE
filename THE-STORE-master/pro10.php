...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="j" style="height:70%;" src="10.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">Moda Rapido Men Blue Colourblocked Round Neck T-shir</h3>

        <p style="color:black;"><del>₹599</del><font color="red"> (20% off)</font><br>₹479 </p>
        ...
        <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="10">
            <br>
             <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Blue colourblocked T-shirt, has a round neck, short sleeves</font></h5>
