...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="g" style="height:70%;" src="7.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">HERE&NOW Men Red Solid Henley Neck T-shirt</h3>

        <p style="color:black;"><del>₹799</del><font color="red"> (30% off)</font><br>₹399 </p>
        ...
        <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="7">
          <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Red solid Henley T-shirt, has a Henley neck, long sleeves</font></h5>
