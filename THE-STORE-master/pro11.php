...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="k" style="height:70%;" src="11.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">HERE&NOW Men Black Solid Round Neck T-shirt</h3>

        <p style="color:black;"><del>₹749</del><font color="red"> (55% off)</font><br>₹337 </p>
        ...
        <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="11">
             <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Black solid T-shirt, has a round neck, long sleeves</font></h5>
