...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="r" style="height:70%;" src="18.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">Forest Essentials Unisex Velvet Silk Madurai Jasmine & Mogra Body Cream</h3>

        <p style="color:black;">Rs.1695</p>
        ...
        <h5 style="font-size:100%; color:black;">SELECT SIZE</h5>
         <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
          <input type="radio" name="size" value="small">200gms</input>
            
            <input type="hidden" name="prodno" value="18">
             <?php
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Forest Essentials Unisex Velvet Silk Madurai
              Jasmine & Mogra body cream<br>
A silken body cream to smooth onto the body while paying more attention to the heels, elbows and knees<br>
Cold-pressed organic oils soften the skin and increase skin's elasticity and its blend of herbs rich in antioxidants along
with Vitamin A and organic beeswax make it excellent for dry and sensitive skin<br>
</font></h5>
