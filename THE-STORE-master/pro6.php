...
<div id="forimg" class="demo one_half" >
    <div class="img">
        <img id="f" style="height:70%;" src="6.jpg" ></img>
        <h6 style="font-size:80%; color:grey;">Product code:234567</h6>
    </div>
</div>

    <div id="fordis" class="dis one_half" style="bottom:-100px;">
        <h2 style="color:black;">Ahalyaa Women Blue Printed A-Line Kurta</h3>

        <p style="color:black;"><del>₹1928</del><font color="red"> (50% off)</font><br>₹964 </p>
       ...
       <form class="one_half two_quarter" style="color:black;" action="mycart.php" method="GET">
            ...
            <input type="hidden" name="prodno" value="6">
             <?php 
        ...
        <hr>
          ...
          <h5 style="font-size:100%; color:black;">Product Details:<br><font color="grey">Blue printed A-line kurta, has a boat neck, short sleeves, asymmetric hem,
          no slits</font></h5>


            <h5 style="font-size:100%; color:black;">Material and Care<br><font color="grey">Cotton<br>Dry-clean</font></h5>
        </div>
